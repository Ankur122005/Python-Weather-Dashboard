...
def GUI(temp,humidity,description,wind_speed,city,ID):
    ...
    # Styles are now for the frame and other
    ...
    #Add Widgets to the NEW card_frame ---
...
def main():
    # It Accept the name from the get_city_prompt() function pass it to get_weather() function 
